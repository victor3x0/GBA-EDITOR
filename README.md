...
Un éditeur visuel pour créer des jeux Game Boy Advance, sans écrire de C à la main : scènes, sprites, collisions et scripts (Lua, transpilé en C) depuis une seule interface. Basé sur Python/PyQt6, s'appuie sur la toolchain officielle **devkitPro** pour compiler de vraies ROMs `.gba` jouables sur émulateur ou hardware.
...
- **Projet démo inclus** (`projects/Pong`) pour voir un jeu complet de bout en bout.

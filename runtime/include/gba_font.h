/* gba_font.h — Police 8x8 1bpp, ASCII 32-90 (espace → Z).
   59 caractères × 8 octets. MSB = pixel gauche.
   Utilisé par text_init() dans gba_engine.h pour charger CBB3. */
#ifndef GBA_FONT_H
#define GBA_FONT_H

#include <gba_types.h>

static const u8 _gba_font_1bpp[59 * 8] = {
    ...
    /* 37 %     */ 0xE2,0x66,0x0C,0x18,0x30,0x66,0x46,0x00,
    ...
    /* 77 M     */ 0x42,0x66,0x7E,0x7E,0x6B,0x63,0x63,0x00,

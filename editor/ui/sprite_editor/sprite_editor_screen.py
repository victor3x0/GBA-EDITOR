...
class SpriteEditorScreen(QWidget):
    ...
    def refresh(self):
        ...
        depuis la dernière visite ; sans cela la grille « + du catalogue » du
        panneau droit restait figée. Bon marché : on relit `project.palettes`
        (déjà en mémoire), pas le PNG du sprite."""
